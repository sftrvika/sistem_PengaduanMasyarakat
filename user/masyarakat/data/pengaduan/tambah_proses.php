...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
      ...
      if(isset($_POST['id_pengaduan']) && isset($_POST['tgl_pengaduan']) && isset($_POST['nik']) && isset($_POST['isi_laporan']) && isset($_POST['status']) && isset($_POST['tambah']))
      {
        move_uploaded_file($file,"gambar/$name");
        $input = mysql_query("INSERT INTO pengaduan VALUES('$id_pengaduan','$tgl_pengaduan', '$nik', '$isi_laporan', '$name', '$status')") or die(mysql_error());
