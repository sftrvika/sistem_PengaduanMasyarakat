...
<div align='center'>
  ...
  <table>
  <tbody>
  <tr><td colspan="2" align="center"><h1>Daftar Baru User</h1></td></tr>
  <tr><td>Nik</td><td> : <input name="nik" type="text" maxlength="16" required=""></td></tr>
  <tr><td>Nama</td><td> : <input name="nama" type="text" required=""></td></tr>
  ...
  <tr><td>Telp</td><td> : <input name="telp" type="text" maxlength="13" required=""></td></tr>
  <tr><td colspan="2" align="right"><input value="Daftar" type="submit" name="tambah"> <input value="Batal" type="reset"></td></tr>
