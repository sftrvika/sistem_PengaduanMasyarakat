...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#FFFFFF">
    <td colspan="3"><table width="798" class="border" bordercolor="#009999" align="center" cellpadding="0" cellspacing="0">
      <tr class="ListBack">
        <td width="597" height="25" valign="middle" >
        </td>
...
<div align='center'>
  ...
  <tr><td colspan="2" align="center">Login Sebagai | <a href="../../login.php"><b>admin</b></a> | <a href="../petugas/login.php"><b>petugas</b></a></td></tr>
  </tbody>
  </table>
  </form>
</div>
