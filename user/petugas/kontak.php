...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#FFFFFF">
    <td colspan="3" bgcolor="#009900"><img src="gambar/1.jpg" height="100"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td colspan="3"><table width="798" class="border" bordercolor="#009999" align="center" cellpadding="0" cellspacing="0">
      <tr class="ListBack">
        <td width="597" height="25" valign="middle" ><img src="gambar/ikon.png" width="9" height="9"> <a href="index.php" target="_self" class="katlink">Beranda</a> | 
          ...
          <a href="data/petugas/petugas.php" target="_self" class="katlink">Data Petugas</a> |
  ...
  <tr>  
    ...
    <td class="jarak" width="100%" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
      <h2>Kontak :)</h2>
                     <h3>Desa timbulharjo</h3>
                      Kode Desa: 340215202 <br>
                     Kepala Desa: Drs.Kandar <br>
                     Alamat Balai Desa: jl.margorejo cangkringmalang mriyan timbulharjo<br>
                     Kode Pos: 55186 <br>
                    Telepon:
E-mail: kantordesa.timbulharjo@yahoo.com
Situs web: http://desatimbulharjo.wordpress.com<br>
    </td>
  </tr>
  </tr>
  <tr bgcolor="#FFFFFF"> 
