        ...
        <table width="100%" class="BorderUtama" border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <?php 
              ...
              $query = mysql_query("SELECT * FROM petugas ORDER BY id_petugas DESC") or die(mysql_error());
              ...
              <tr>
                ...
                <td class="garis"><?php echo $data['username'] ?></td>
                <td class="garis"><?php echo $data['password'] ?></td>
                <td class="garis"><?php echo $data['telp'] ?></td>
                <td class="garis"><?php echo $data['level'] ?></td>
                <td class="garis">
                  <a href="edit.php?id=<?php echo $data['id_petugas'] ?>" class="katlink">Edit</a> | 
                  <a href="hapus.php?id=<?php echo $data['id_petugas'] ?>" onclick="return confirm('apa anda yakin')" class="katlink">Hapus</a>
                </td>
              </tr>
              <?php
              $no++;
