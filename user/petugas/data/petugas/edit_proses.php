...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td colspan="3"><table width="798" class="border" bordercolor="#009999" align="center" cellpadding="0" cellspacing="0">
      <tr class="ListBack">
        <td width="597" height="25" valign="middle" ><img src="../../gambar/ikon.png" width="9" height="9"> 
          ...
          <a href="petugas.php" target="_self" class="katlink">Data Petugas</a> |
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
          <?php 
      if(isset($_POST['id_petugas']) && isset($_POST['nama_petugas']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['telp']) && isset($_POST['level']) && isset($_POST['simpan']))
      {
        ...
        $input = mysql_query("UPDATE petugas SET id_petugas = '$id_petugas', nama_petugas = '$nama_petugas', username = '$username', password = '$password', telp= '$telp', level= '$level'  WHERE id_petugas = '$id_petugas'") or die(mysql_error());

        if($input){
          echo "data berhasil di edit";
          echo "<a href='petugas.php'>back</a>";
        }
        else{
