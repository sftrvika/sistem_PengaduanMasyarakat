...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
          <?php 
      if(isset($_POST['id_petugas']) && isset($_POST['nama_petugas']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['level']) && isset($_POST['telp']) && isset($_POST['tambah']))
      {
        ...
        $input = mysql_query("INSERT INTO petugas VALUES('$id_petugas','$nama_petugas', '$username', '$password', '$telp', '$level')") or die(mysql_error());
