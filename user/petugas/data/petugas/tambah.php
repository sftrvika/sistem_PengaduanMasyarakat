          ...
          <tr>
            <td class="registrasi">
              <fieldset class="baris2">
                        ...
                        <p>
                            <label>Id</label>
                            <input type="text" maxlength="11" name="id_petugas" required>
                        </p>
                        <p>
                            <label>Nama</label>
                            <input type="text" maxlength="16" name="nama_petugas" required>
                        </p>
                        <p>
                        ...
                        <p>
                            <label>Telpon</label>
                            <input type="text" name="telp" size="50" maxlength="13" required/>
                        </p>
                        <p>
                            <label>Level</label>
