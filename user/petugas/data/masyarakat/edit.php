  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
        <?php 
          ...
          $id = $_GET['id'];
          $show = mysql_query("SELECT * FROM masyarakat WHERE nik = '$id'");
          ...
          <tr>
            <td class="registrasi">
              <fieldset class="baris2">
                        ...
                        <p>
                            <label>Nik</label>
                            <input type="text" value="<?php echo $data['nik'];  ?>"  maxlength="16" name="nik" required/>
                        </p>
                        <p>
                            <label>Nama</label>
                            <input type="text" value="<?php echo $data['nama'];  ?>"  name="nama" size="50" maxlength="50" required/>
                        </p>
                        <p>
