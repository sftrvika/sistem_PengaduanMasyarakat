    ...
    <td colspan="3"><table width="798" class="border" bordercolor="#009999" align="center" cellpadding="0" cellspacing="0">
      <tr class="ListBack">
        <td width="597" height="25" valign="middle" ><img src="../../gambar/ikon.png" width="9" height="9"> 
          ...
          <a href="../../report.php" target="_self" class="katlink">Repor</a> |
        ...
        <table width="100%" class="BorderUtama" border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <?php 
              ...
              $query = mysql_query("SELECT * FROM masyarakat ORDER BY nik DESC") or die(mysql_error());
              ...
              <tr>
                ...
                <td class="garis"><?php echo $data['nama'] ?></td>
                <td class="garis"><?php echo $data['username'] ?></td>
                <td class="garis"><?php echo $data['password'] ?></td>
                <td class="garis"><?php echo $data['telp'] ?></td>
                <td class="garis">
                  <a href="edit.php?id=<?php echo $data['nik'] ?>" class="katlink">Edit</a> | 
                  <a href="hapus.php?id=<?php echo $data['nik'] ?>" onclick="return confirm('apa anda yakin')" class="katlink">Hapus</a>
                </td>
              </tr>
              <?php
              $no++;
