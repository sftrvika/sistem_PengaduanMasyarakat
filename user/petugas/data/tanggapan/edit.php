    ...
    <td colspan="3"><table width="798" class="border" bordercolor="#009999" align="center" cellpadding="0" cellspacing="0">
      <tr class="ListBack">
        <td width="597" height="25" valign="middle" ><img src="../../gambar/ikon.png" width="9" height="9"> 
          ...
          <a href="tanggapan.php" target="_self" class="katlink">Data Petugas</a> |
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <tr> 
        ...
        <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2"  >
          ...
          <td width="92%"><a href="../masyarakat/masyarakat.php" target="_self" class="katlink">Masyarakat</a></td>
        </tr> 
        <tr>
          <td width="8%"><img src="../../gambar/shutdown.png" width="15" height="15"></td>
        ...
        <tr>
          <td><img src="../../gambar/shutdown.png" width="15" height="15"></td>
          <td><a href="tanggapan.php" target="_self" class="katlink">Tanggapan</a></td>
          </tr>
        </table>
        </tr>   
        <tr align="center" class="ListBack"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
        <?php 
          ...
          $id = $_GET['id'];
          $show = mysql_query("SELECT * FROM tanggapan WHERE id_tanggapan = '$id'");
        ...
        <input type="hidden" name="id_tanggapan" value="<?php echo $id;  ?>">
        <h2>Edit Data Tanggapan</h2>
        <p><a href="tanggapan.php" class="katlink">Home</a></p>
            ...
            <td class="registrasi">
              <fieldset class="baris2">
                        ...
                        <p>
                            ...
                            <input type="text" value="<?php echo $data['id_tanggapan'];  ?>"  maxlength="11" name="id_tanggapan" required/>
                        </p>
                        <p>
                            <label>Id Pengaduan</label>
                            <input type="text" value="<?php echo $data['id_pengaduan'];  ?>"  name="id_pengaduan" size="50" maxlength="50" required/>
                        </p>
                        <p>
                            <label>Tanggal</label>
                            <input type="date" value="<?php echo $data['tgl_tanggapan'];  ?>"  name="tgl_tanggapan" size="50" maxlength="50" required/>
                        </p>
                        <p>
                            <label>Tanggapan</label>
                            <textarea name="tanggapan"required><?php echo $data['tanggapan'];  ?></textarea>
                        </p>
                        <p>
                            <label>Id Petugas</label>
                            <input type="text" value="<?php echo $data['id_petugas'];  ?>"  name="id_petugas"  maxlength="16" required>
                        </p>
                    </fieldset>
                </td>
              </tr>
