...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
      ...
      <input type="hidden" name="id_tanggapan" value="<?php echo $id_tanggapan;  ?>">

        <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td class="registrasi">
              <fieldset class="baris2">
                        <legend>Data Tanggapan
                        </legend>
                        <p>
                            <label>Id Tanggapan</label>
                            <input type="text" maxlength="11" name="id_tanggapan" required>
                        </p>
                        <p>
                        ...
                        <p>
                            <label>Tanggal</label>
                            <input type="date" name="tgl_tanggapan" maxlength="50" required/>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <input type="text" name="id_petugas"  maxlength="11" required>
                        </p>
                    </fieldset>
            </td>
          </tr>
