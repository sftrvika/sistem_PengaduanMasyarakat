  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <tr align="center" class="ListBack"> 
       ...
       <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
          <td width="16%" height="26" align="center" bgcolor="#009900" ><img src="../../gambar/user_red.png" width="20" height="20"></td>
          <td width="84%" bgcolor="#009900" class="HEAD"><strong>MENU UTAMA</strong></td>
        </tr>
      </table>      </td>
        </tr>     
    <tr> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
          <?php 
      if(isset($_POST['id_tanggapan']) && isset($_POST['id_pengaduan']) && isset($_POST['tgl_tanggapan']) && isset($_POST['tanggapan']) && isset($_POST['id_petugas']) && isset($_POST['simpan']))
      {
        ...
        $input = mysql_query("UPDATE tanggapan SET id_tanggapan = '$id_tanggapan', id_pengaduan = '$id_pengaduan', tgl_tanggapan = '$tgl_tanggapan', tanggapan = '$tanggapan', id_petugas= '$id_petugas' WHERE id_tanggapan = '$id_tanggapan'") or die(mysql_error());

        if($input){
          echo "data berhasil di edit";
          echo "<a href='tanggapan.php'>back</a>";
        }
        else{
