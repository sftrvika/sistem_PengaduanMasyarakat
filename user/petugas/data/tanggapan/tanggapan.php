        ...
        <table width="100%" class="BorderUtama" border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <?php 
              ...
              $query = mysql_query("SELECT * FROM tanggapan ORDER BY id_tanggapan DESC") or die(mysql_error());
              ...
              <tr>
                ...
                <td class="garis"><?php echo $data['id_tanggapan'] ?></td>
                ...
                <td class="garis">
                  <a href="edit.php?id=<?php echo $data['id_tanggapan'] ?>" class="katlink">Edit</a> | 
                  <a href="hapus.php?id=<?php echo $data['id_tanggapan'] ?>" onclick="return confirm('apa anda yakin')" class="katlink">Hapus</a>
                </td>
              </tr>
              <?php
              $no++;
