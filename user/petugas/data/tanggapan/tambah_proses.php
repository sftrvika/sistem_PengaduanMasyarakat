...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
          <?php 
      if(isset($_POST['id_tanggapan']) && isset($_POST['id_pengaduan']) && isset($_POST['tgl_tanggapan']) && isset($_POST['tanggapan']) && isset($_POST['id_petugas']) && isset($_POST['tambah']))
      {
        ...
        $input = mysql_query("INSERT INTO tanggapan VALUES('$id_tanggapan','$id_pengaduan', '$tgl_tanggapan', '$tanggapan', '$id_petugas')") or die(mysql_error());
