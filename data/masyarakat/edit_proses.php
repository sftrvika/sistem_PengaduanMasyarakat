...
<table width="798" class="border" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" class="BorderUtama" border="0" cellpadding="0" cellspacing="0"> 
    ...
    <td width="610" valign="top" bgcolor="#FFFFFF" class="BorderUtama">
          <?php 
      if(isset($_POST['nik']) && isset($_POST['nama']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['telp']) && isset($_POST['simpan']))
      {
        ...
        $input = mysql_query("UPDATE masyarakat SET nik = '$nik', nama = '$nama', username = '$username', password = '$password', telp= '$telp' WHERE nik = '$nik'") or die(mysql_error());

        if($input){
          echo "data berhasil di edit";
          echo "<a href='masyarakat.php'>back</a>";
        }
        else{
